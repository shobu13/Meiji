...
## Transitions #################################################################
##
## Ces varaibles configurent les transitions qui sont utilisées quand certains
...
## Le délai d’avancée automatique. Des nombres importants entraîne une longue
...
##
## Ces valeurs, dépendant de la plateforme, détermine l’emplacement où Ren’Py
...
define config.save_directory = "Ezo2-1527247866"
